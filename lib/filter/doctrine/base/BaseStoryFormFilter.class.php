...
abstract class BaseStoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'story_place_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('StoryPlace'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'story_place_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('StoryPlace'), 'column' => 'id')),
