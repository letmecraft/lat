...
-->
    <section id="map">
            <?php foreach ( $stories as $story ): ?>
            <li class="pin" style="left:<?php echo $story->pos_x ?>%; bottom:<?php echo $story->pos_y ?>%;" data-title="Blabla" data-cover="http://inapcache.boston.com/universal/site_graphics/blogs/bigpicture/ramadan2013a/bp1.jpg">
